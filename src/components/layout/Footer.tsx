		...
		<footer className="relative z-10 w-full px-6 py-12 flex flex-col items-center border-t border-white/20 mt-12 bg-black/10 backdrop-blur-sm">
			<div className="max-w-6xl w-full flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
				<div className="flex flex-col items-center md:items-start opacity-80 hover:opacity-100 transition-opacity">
					<Image
						src="/assets/logo-svgs/white.svg"
						alt="Transpo"
						width={48}
						height={48}
						className="mb-2"
						unoptimized
					/>
					<span className="font-calistoga font-bold tracking-wide text-white">
						make it yours.
					</span>
					<div className="flex gap-4 mt-4 text-white">
						<a
							href="https://www.instagram.com/transpo.studio/"
							target="_blank"
							rel="noopener noreferrer"
							className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/30 hover:scale-110 transition-all cursor-pointer"
						>
							<svg
						...
						<a
							href="https://linkedin.com/transpo-studio"
							target="_blank"
							rel="noopener noreferrer"
							className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/30 hover:scale-110 transition-all cursor-pointer"
						>
